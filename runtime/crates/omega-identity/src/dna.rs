...
pub fn identity_prompt(did: &str, _treasury_summary: &str) -> String {
    format!(
        "You are an AI agent in the OmegA system. Node DID: {}.",
        did
    )
}
...
pub fn public_identity_prompt() -> String {
    "You are OmegA. PUBLIC MODE.".to_string()
}

/// Returns the full chronology as a structured report.
pub fn get_chronology_report() -> String {
    let mut report = String::from("--- ΩmegΩ GENETIC CHRONOLOGY ---\n");
